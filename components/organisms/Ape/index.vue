  ...
  <div class="ape">
    ...
    <div class="ape__success" v-else>
      <div class="ape__left">
        ...
        <a class="ape__cta" :href="`https://boredapetronclub.com/ape/${ape.tokenId}`" target="_blank">
          <img src="~/assets/svg/bored-ape-logo.svg" class="ape__cta-image" alt="bored ape" />
